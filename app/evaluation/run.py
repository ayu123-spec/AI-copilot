...
CORPUS = {
    "finance.txt": "The company reported that quarterly revenue grew 20 percent, driven by cloud services and enterprise subscriptions.",
    "hr.txt": "Employees are entitled to 25 days of paid annual leave and flexible remote working arrangements.",
    "security.txt": "All customer data is encrypted at rest using AES-256 and access requires multi-factor authentication.",
    "product.txt": "The product roadmap prioritizes a mobile app, offline sync, and a public API for integrations.",
}

CASES = [
    EvalCase("How much did revenue grow last quarter?", "revenue grew 20 percent"),
    EvalCase("How many vacation days do employees get?", "25 days of paid annual leave"),
...
def main() -> None:
    ...
    chunks = [Chunk(text=t, metadata={"source": s, "workspace_id": "eval"}) for s, t in CORPUS.items()]
    ...
    print(f"\nRetrieval evaluation  (embedder={embedder.__class__.__name__}, k={m['k']}, cases={m['num_cases']})")
    print("-" * 58)
